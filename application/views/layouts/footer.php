<div class="section clearfix section-colored7"><!--section start-->
    ...
    <div class="container"><!--container Start-->
        ...
        <div class="Download_Cont_Top_Left left"><!--Download_Cont_Top Start-->
            <img src="<?php echo base_url(); ?>public/images/icon5.png" alt=""> <h1 style="display:inline;">FREE: Men Are From Mars</h1> <a href="#">Download Now</a>
...
<footer class="footer_wrapper">
    ...
    <div class="container"><!--container Start-->
        ...
        <div class="Footer_Cont_Top clearfix"><!--Footer_Cont_Top Start-->
            ...
            <span class="left"><img src="<?php echo base_url(); ?>public/images/foot_logo.png" alt=""></span>
        ...
        <div class="Footer_Cont_Top2 clearfix"><!--Footer_Cont_Top2 Start-->
            ...
            <a href="#">Book an Appointment <img src="<?php echo base_url(); ?>public/images/icon7.png" alt=""></a>
            <a href="#">Contact a Consultant <img src="<?php echo base_url(); ?>public/images/icon6.png" alt=""></a>
